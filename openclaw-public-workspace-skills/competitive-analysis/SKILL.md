...
output_file = output_dir / f"{company}_Competitive_Analysis_{date}.pptx"
```
...
Example:
```
✅ 任务完成，文件已生成：CATL_Competitive_Analysis_2026-03-06.pptx
```
...
2. **ALL competitive/financial data must be from web_search**, not training data
3. **Target data freshness:** Use **最新季度优先，其次 FY2025**
4. **Never use pre-2024 data** for revenue, market share, or financial metrics

**Data Verification Checklist:**
- [ ] All company financials include explicit data date (latest fiscal year or most recent quarter)
- [ ] Market share data is current (within last 12 months)
- [ ] Revenue/growth numbers cite source URLs
- [ ] No use of training data knowledge (cutoff: early 2024) without explicit labeling
...
print(f"✅ Competitive analysis completed: {len(completed_files)} files generated")

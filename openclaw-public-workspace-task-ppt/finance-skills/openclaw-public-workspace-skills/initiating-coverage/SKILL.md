...
Example:
```
✅ 任务完成，文件已生成：CATL_Initiating_Coverage_2026-03-06.docx
```
...
**BEFORE STARTING (Apply to ALL 5 Tasks):**
1. **Check today's date** and write it down
2. **ALL company financials must be from web_search**, not training data
3. **Target data freshness:** Use 最新季度优先，其次 FY2025 annual reports, or latest quarterly results
4. **Never use pre-2024 data** for revenue, earnings, or market metrics without explicit disclosure

**Per-Task Requirements:**
- **Task 1 (Research)**: Use "[Company] 最新季度 earnings" or "[Company] FY2025 annual results"
- **Task 2 (Model)**: Historicals from FY2020-2024 via EDGAR or company investor relations
- **Task 3 (Valuation)**: Current market cap and multiples from latest trading data
- **Task 4 (Charts)**: 1-year stock chart with current price data
- **Task 5 (Report)**: All data points include source citations with dates

**Verification Checklist:**
- [ ] All revenue/earnings numbers include explicit fiscal year (最新季度优先，其次 FY2025)
- [ ] Market data is current (within last 3 months)
- [ ] No use of training data cutoff knowledge (early 2024)
- [ ] Source URLs provided for all financial statements

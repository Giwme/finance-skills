...
2. **ALL screening metrics must be current**, not from training data
3. **Target data freshness:** Use 最新季度优先，其次 FY2025 results or latest quarterly data
4. **Never use pre-2024 valuation multiples or growth rates**

**Screening Data Requirements:**
- [ ] P/E, EV/EBITDA multiples are current (within last 3 months)
- [ ] Revenue/earnings growth uses 最新季度优先，其次 FY2025 or latest quarter YoY
- [ ] Stock prices are current (within last trading day)
- [ ] Thematic trends verified with recent sources (2024-2025)

**COMMON MISTAKE**: Using outdated valuation multiples from training data cutoff.
